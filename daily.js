...
const dailyMessages = {
   1: `🔱 ថ្ងៃទី ១: ចាប់ផ្តើមស្គាល់ Money Flow របស់អ្នក + រកលុយភ្លាម! 🔱
---

🔥 គោលដៅថ្ងៃនេះ: រកលុយ $30+ ក្នុង ២០ នាទី តាមវិធីសាស្ត្រពិតប្រាកដ!

👋 ជំរាបសួរ! ថ្ងៃនេះយើងនឹងមកយល់ដឹងអំពីលុយរបស់អ្នកឱ្យបានច្បាស់លាស់ និងរកលុយភ្លាមៗ! ចូរគិតថាវាដូចជាការស្វែងរក 'ទុយោលុយលេចធ្លាយ' តូចៗដែលអ្នកប្រហែលជាមិនធ្លាប់ដឹង!

💎 តំបន់សកម្មភាពបន្ទាន់ (២០ នាទី)

⚡ ជំហានភ្លាមៗ (៥ នាទី): ពិនិត្យ Digital Subscriptions
...
💡 ការលេចធ្លាយលុយឌីជីថលទូទៅនៅកម្ពុជា:
...
🚗 ជំហានភ្លាមៗ (១០ នាទី): ពិនិត្យទម្លាប់ប្រចាំថ្ងៃនៅកម្ពុជា
...
សរុបប្រាក់ដែលបានរកឃើញ: $____/ខែ = $____/ឆ្នាំ! (នេះជាលុយដែលអ្នកទើបតែបានរកឃើញ!)

🏆 ការធានា: រកមិនបាន $30/ខែ? ទាក់ទង @Chendasum (Telegram/WhatsApp) នឹងទទួលបានប្រឹក្សាឥតគិតថ្លៃ!
...
✅ ជំហានទី៣ - ចាប់ផ្តើមស្វែងរកការលេចធ្លាយលុយ (Money Leak Hunt)
...
🎁 BONUS ដោះសោ: រកបាន $30+ ថ្ងៃនេះ → ទទួលបាន "បញ្ជីត្រួតពិនិត្យការលេចធ្លាយលុយនៅកម្ពុជា" ពិសេស!

✅ កិច្ចការបានបញ្ចប់:
ធ្វើរួចហើយ? សរសេរថា "DAY 1 COMPLETE - រកបាន $____/ខែ" ដើម្បីឆ្ពោះទៅថ្ងៃទី ២!

ស្អែកយើងនឹងធ្វើការស្វែងរក "ប្រព័ន្ធកំណត់អត្តសញ្ញាណការលេចធ្លាយលុយកម្រិតខ្ពស់" ដើម្បីរកកន្លែងដែលលុយលេចធ្លាយទៅដោយមិនដឹងខ្លួន!

🌐 ធនធានបន្ថែម: 7daymoneyflow.com

បញ្ចប់? ចុច /day2`,

   2: `🔱 ថ្ងៃទី ២: Advanced Money Leak Detection - រកបាន $50-200 ក្នុង 30 នាទី! 🔱

🔥 គោលដៅថ្ងៃនេះ: រកកន្លែងលុយលេចធ្លាយ $50+ ក្នុង ៣០ នាទី តាមវិធីសាស្ត្រពិតប្រាកដ!

👋 ជំរាបសួរម្តងទៀត! ថ្ងៃម្សិលមិញអ្នកបានរកលុយ $30+ រួចហើយ។ ថ្ងៃនេះយើងនឹងស្វែងរកកន្លែងលុយលេចធ្លាយសម្ងាត់ដែលធ្វើឱ្យអ្នកខាតបង់កាន់តែច្រើន! គិតថាវាដូចជាការស្វែងរក 'ស្នាមប្រេះតូចៗ' នៅក្នុងប្រព័ន្ធហិរញ្ញវត្ថុរបស់អ្នក។

💎 ប្រព័ន្ធកំណត់អត្តសញ្ញាណការលេចធ្លាយកម្រិតខ្ពស់ (៣០ នាទី)
...
💡 ការលេចធ្លាយលុយតាមបណ្តាញសង្គមនៅកម្ពុជា:
...
💡 ការលេចធ្លាយលុយប្រចាំថ្ងៃតូចៗនៅកម្ពុជា:
• ទឹកកក/ភេសជ្ជៈ $1 × 25ថ្ងៃ = $25/ខែ
• កាហ្វេនៅការិយាល័យ $1.5 × 20ថ្ងៃ = $30/ខែ
• ស្រាបៀរតូច $3 × 10ដង = $30/ខែ
• ថ្នាំបារី/បង្អែម $0.5 × 30ថ្ងៃ = $15/ខែ

📊 ម៉ាស៊ីនគណនាការលេចធ្លាយ - គណនាភ្លាមៗ:
- ការទិញភ្លាមៗតាមបណ្តាញសង្គម: $____/ខែ
- ការជាវលាក់កំបាំង: $____/ខែ
- ទម្លាប់ចំណាយតូចៗប្រចាំថ្ងៃ: $____/ខែ
- ការលេចធ្លាយផ្សេងទៀតដែលបានរកឃើញ: $____/ខែ
សរុបការលេចធ្លាយដែលរកឃើញ: $____/ខែ = $____/ឆ្នាំ! (អ្នកទើបតែបិទកន្លែងខាតធំ!)
...
🚨 តើអ្វីទៅជាកន្លែងលុយលេចធ្លាយ?

កន្លែងលុយលេចធ្លាយ គឺដូចជាបំពង់ទឹកដែលលេចធ្លាយតូចៗ... ពេលដំបូងអ្នកមិនសូវកត់សម្គាល់ទេ តែបើសិនជាទុកចោលយូរ វានឹងធ្វើឱ្យអ្នកខាតបង់ទឹកយ៉ាងច្រើន!
...
🔍 កន្លែងដែលលុយលេចធ្លាយទាំង ៥ ប្រភេទសំខាន់ៗនៅកម្ពុជា:

1️⃣ ការលេចធ្លាយឌីជីថល (Digital Leaks - ការជាវអនឡាញ)
...
2️⃣ ការលេចធ្លាយពីភាពងាយស្រួល (Convenience Leaks - ចំណាយដើម្បីភាពងាយស្រួល)
• ថ្លៃដឹកជញ្ជូនអាហារ (Food Delivery fees) ពី $20-40/ខែ
• Grab ចម្ងាយខ្លី ពី $50/ខែ
• តាក់ស៊ីដោយមិនចាំបាច់ ពី $30+/ខែ

3️⃣ ការលេចធ្លាយពីការទិញភ្លាមៗ (Impulse Leaks - ចំណាយភ្លាមៗ)
...
✅ ជំហានទី១ - ការកំណត់អត្តសញ្ញាណការលេចធ្លាយកម្រិតខ្ពស់
→ ធ្វើតាមប្រព័ន្ធ ៣០ នាទីខាងលើ
→ កត់ត្រារាល់ការលេចធ្លាយដែលរកឃើញទាំងអស់
...
១. "តើកន្លែងលុយលេចធ្លាយណាខ្លះដែលធ្វើឱ្យខ្ញុំភ្ញាក់ផ្អើលបំផុត?"
...
• ចាប់ផ្តើមពីចំណុចតូចបំផុត - កាត់បន្ថយការលេចធ្លាយលុយតែ ២-៣ យ៉ាងមុនសិន
...
• អនុវត្តភ្លាមៗ - កុំពន្យារពេលក្នុងការកំណត់អត្តសញ្ញាណការលេចធ្លាយ!
...
🎁 BONUS ដោះសោ: រកបាន $50+ ថ្ងៃនេះ → ទទួលបាន "ឧបករណ៍ត្រួតពិនិត្យការលេចធ្លាយលុយកម្រិតខ្ពស់នៅកម្ពុជា" ពិសេស!
...
បញ្ចប់? ចុច /day3`,
   ...
   3: `🔱 ថ្ងៃទី ៣: Personal Finance Health Check - ដឹងពីសុខភាពលុយក្នុង ១៥ នាទី! 🔱

🔥 គោលដៅថ្ងៃនេះ: ទទួលបាន Personal Finance Score + កែលម្អតាមលទ្ធភាពខ្លួនឯង!

👋 ជំរាបសួរម្តងទៀត! ថ្ងៃមុនៗអ្នកបានរកលុយ $30+ និងបិទកន្លែងលេចធ្លាយលុយ $50+ រួចហើយ។ ថ្ងៃនេះយើងនឹងពិនិត្យមើលសុខភាពហិរញ្ញវត្ថុទាំងមូលរបស់អ្នក!

💎 ប្រព័ន្ធត្រួតពិនិត្យសុខភាពហិរញ្ញវត្ថុ (១៥ នាទី)

⚡ ជំហានទី១ (៥ នាទី): ការវាយតម្លៃការតាមដានលុយ
→ បើកកម្មវិធីដែលអ្នកប្រើដើម្បីតាមដានចំណាយ (សៀវភៅកត់ត្រា ឬ ទូរស័ព្ព)
...
🏆 ការធានា: មិនអាចកែលម្អបាន ២០+ ពិន្ទុក្នុង ៧ ថ្ងៃ? ទាក់ទង @Chendasum (Telegram/WhatsApp) នឹងទទួលបានប្រឹក្សាឥតគិតថ្លៃ!
...
បញ្ចប់? ចុច /day4`,
   ...
   4: `🔱 ថ្ងៃទី ៤: Money Flow Calculator - ដឹងលំហូរលុយពិតក្នុង ១០ នាទី! 🔱

🔥 គោលដៅថ្ងៃនេះ: ស្គាល់ Money Flow Pattern ពិតប្រាកដ + កំណត់ទិសដៅកែលម្អច្បាស់លាស់!

👋 ជំរាបសួរម្តងទៀត! ថ្ងៃមុនៗអ្នកបានរកលុយ $30+, បិទកន្លែងលេចធ្លាយលុយ $50+, និងទទួលបាន Health Check Score រួចហើយ។ ថ្ងៃនេះយើងនឹងគណនាលំហូរលុយពិតប្រាកដរបស់អ្នក!
...
🏆 ការធានា: មិនអាចកែលម្អលំហូរលុយ (Money Flow) ១៥% ក្នុង ៧ ថ្ងៃ? ទាក់ទង @Chendasum (Telegram/WhatsApp) នឹងទទួលបានប្រឹក្សាឥតគិតថ្លៃ!
...
✅ បើលំហូរលុយ (Money Flow) អវិជ្ជមាន (-):
...
១. "តើលំហូរលុយ (Money Flow) របស់ខ្ញុំវិជ្ជមាន ឬ អវិជ្ជមាន?"
...
🎁 BONUS ដោះសោ: កែលម្អលំហូរលុយ (Money Flow) ១៥%+ → ទទួលបាន "មគ្គុទេសក៍បង្កើនប្រសិទ្ធភាពចំណូលនៅកម្ពុជា" ពិសេស!
...
បញ្ចប់? ចុច /day5`,
   ...
   5: `🔱 ថ្ងៃទី ៥: Spending Balance Analyzer - ដឹងតុល្យភាពចំណាយក្នុង 15 នាទី! 🔱

🔥 គោលដៅថ្ងៃនេះ: វិភាគតុល្យភាព Survival vs Growth vs Lifestyle + បង្កើតផែនការសកម្មភាពស្មោះត្រង់!

👋 ជំរាបសួរម្តងទៀត! ថ្ងៃមុនៗអ្នកបានបង្កើនប្រសិទ្ធភាពលំហូរលុយ (Money Flow) រួចហើយ។ ថ្ងៃនេះយើងនឹងវិភាគថាតើអ្នកចំណាយលុយសម្រាប់អ្វីខ្លះ - ការរស់រាន, ការលូតលាស់, ឬ ការកម្សាន្ត?
...
🏆 ការធានា: មិនអាចរៀបចំតុល្យភាពចំណាយ (rebalance spending) ១៥% ក្នុង ១០ ថ្ងៃ? ទាក់ទង @Chendasum (Telegram/WhatsApp) នឹងទទួលបានប្រឹក្សាឥតគិតថ្លៃ!
...
បញ្ចប់? ចុច /day6`,
   ...
   6: `🔱 ថ្ងៃទី ៦: Action Priority Matrix - កំណត់ចំណុចសំខាន់ក្នុង 10 នាទី! 🔱

🔥 គោលដៅថ្ងៃនេះ: ទទួលបាន Personal Action Plan ៣ ចំណុច + ផែនការ ៣០ ថ្ងៃច្បាស់លាស់!

👋 ជំរាបសួរម្តងទៀត! ក្នុងរយៈពេល ៥ ថ្ងៃមុននេះ អ្នកបានបង្កើនប្រសិទ្ធភាពតុល្យភាពចំណាយរបស់អ្នករួចហើយ។ ថ្ងៃនេះយើងនឹងកំណត់ថាតើត្រូវបញ្ឈប់ (Stop)/ចាប់ផ្តើម (Start)/បន្ត (Continue) អ្វីខ្លះដើម្បីកាន់តែជោគជ័យ!
...
🏆 ការធានា: មិនអាចសម្រេចបាន ៧០% នៃផែនការសកម្មភាពក្នុង ៣០ ថ្ងៃ? ទាក់ទង @Chendasum (Telegram/WhatsApp) នឹងទទួលបានប្រឹក្សាឥតគិតថ្លៃ!
...
→ ចាប់ផ្តើមសកម្មភាពបញ្ឈប់ (STOP action) ភ្លាមៗ
→ រៀបចំប្រព័ន្ធសម្រាប់សកម្មភាពចាប់ផ្តើម (START action)
→ តាមដានវឌ្ឍនភាពជារៀងរាល់ថ្ងៃ
→ អនុវត្តសកម្មភាពបន្ត (CONTINUE action)

សប្តាហ៍ទី ២ (ថ្ងៃ ៨-១៤):
→ បន្តសកម្មភាពបញ្ឈប់ (STOP action) + មើលលទ្ធផល
→ ចាប់ផ្តើមសកម្មភាពចាប់ផ្តើម (START action) ពេញលេញ
→ បង្កើនប្រសិទ្ធភាពសកម្មភាពបន្ត (CONTINUE action)
...
→ កែសម្រួលកាលកំណត់ (timeline) ប្រសិនបើត្រូវការ
...
បញ្ចប់? ចុច /day7`,
   ...
   7: `🔱 ថ្ងៃទី ៧: GRADUATION DAY - វាស់ជោគជ័យ និងជំហានបន្ទាប់! 🔱
...
→ ថ្ងៃទី ២: បិទការលេចធ្លាយលុយ $____/ខែ
...
៣. "តើខ្ញុំចង់ក្លាយជាអ្នកគ្រប់គ្រងលុយ (Money Manager) ឬ អ្នកកសាងទ្រព្យសម្បត្តិ (Wealth Builder)?"
...
async function handle(msg, match, bot) {
   ...
   try {
      ...
      // Specific check for Day 1: User must explicitly be "ready"
      ...
      if (dailyMessages[dayNumber]) {
         ...
         await Progress.findOneAndUpdate(
            { userId: userId },
            {
               [`day${dayNumber}Accessed`]: true, // Mark this specific day as accessed
               lastAccessedDay: dayNumber, // Set the current day as the last accessed day
               completionPercentage: Math.floor((dayNumber / 7) * 100), // Calculate overall program completion
